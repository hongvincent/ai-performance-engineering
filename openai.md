...
- ✨ **GPT-4.1 시리즈 출시** (2025년 4월 14일): 1M 토큰 컨텍스트, 향상된 코딩 성능
- 🚀 **GPT-4.1 mini**: GPT-4o 대비 83% 비용 절감, 50% 레이턴시 감소
- ⚡ **GPT-4.1 nano**: OpenAI 최초의 nano 모델, 가장 빠르고 저렴한 옵션
- 🎯 **지식 컷오프**: 2024년 6월
- 📊 **코딩 성능**: SWE-bench Verified에서 54.6% 달성 (GPT-4o 대비 +21.4%p)
...
**참고**: 가격은 변경될 수 있습니다. 최신 정보는 [OpenAI 공식 가격표](https://openai.com/api/pricing/)를 확인하세요.
